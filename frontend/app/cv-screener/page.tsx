                ...
                {result && (
                    <div className="bg-white rounded-lg shadow-md p-6 space-y-6">
                        ...
                        <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                            <h3 className="text-xl font-bold text-gray-900 mb-3">🎯 Candidate Confidence</h3>
                            <div className="flex items-center gap-3 mb-2">
                                <span className="font-semibold text-gray-700">Level:</span>
                                <span className={`px-3 py-1 rounded-full text-sm font-medium ${result.confidence_level === 'High' ? 'bg-green-100 text-green-800' :
                            ...
                            <p className="text-gray-700">{result.confidence_analysis}</p>
                        </div>
